...
void RegisterWindowClass(HINSTANCE hInst, const TCHAR* windowClassName)
{
...
HWND CreateWindowE(const TCHAR* windowClassName, HINSTANCE hInst, const TCHAR* windowTitle, uint32_t width, uint32_t height)
{
...
int CALLBACK wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PWSTR lpCmdLine, int nCmdShow)
{
	...
	const TCHAR* windowClassName = L"DX12WindowClass";
	...
	g_hWnd = CreateWindowE(windowClassName, hInstance, L"Learning DirectX 12",
